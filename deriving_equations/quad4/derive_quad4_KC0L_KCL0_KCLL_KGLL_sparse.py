"""
Nonlinear constitutive stiffness matrix KCNL for the Quad4 element
...
strain, called KGNL in pyfe3d/quad4.pyx. update_KG builds the geometric
...
print()
print()
# same terms in terms of w_x, w_y and NNL, as implemented in quad4.pyx
var('w_x, w_y')
