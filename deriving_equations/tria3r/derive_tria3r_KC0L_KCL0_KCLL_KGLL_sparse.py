"""
Nonlinear constitutive stiffness matrix KCNL for the Tria3R element
...
strain, called KGNL in pyfe3d/tria3r.pyx. update_KG builds the geometric
...
All terms are given in element coordinates at the single integration point of
update_KG, with wij = 1/2 and detJ = 2*area, since the strains of the linear
triangle are constant within the element.
...
# u v w  rx  ry  rz  (node 1, node2, node3)
...
print()
print()
# same terms in terms of w_x, w_y and NNL, as implemented in tria3r.pyx
var('w_x, w_y')
...
# NOTE update_KCNL in tria3r.pyx stores every term of every 6x6 node block,
#     in the order
